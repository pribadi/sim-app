            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><a href="position_create.php"><button class="btn btn-primary">Add</button></a></div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
                                        ...
                                        <?php while($data = mysql_fetch_array($query)): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="position_edit.php?id=<?php echo $data['id_position']; ?>"><i class="fa fa-edit"></i> Edit</a> |
